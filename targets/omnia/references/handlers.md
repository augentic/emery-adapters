...
For the canonical export patterns (struct definitions, trait implementations, handler invocation patterns, and error handling), see [guest-patterns.md](guest-patterns.md).
...
For detailed handler patterns, route methods, error handling, and individual handler signatures, see [guest-patterns.md](guest-patterns.md).
