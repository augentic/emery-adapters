...
**Trait definition:** See [../../references/capabilities.md](../../../capabilities.md#publisher)
...
1. **Hardcoded base topics with env prefix** -- Define base topic names as `const &str`, read `ENV` from Config, format as `{env}-{TOPIC}`. See [capabilities.md](../../../capabilities.md#topic-naming-pattern).
