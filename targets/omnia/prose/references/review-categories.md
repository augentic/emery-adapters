...
- [`adapters/codex/rules/universal/`](../../../codex/rules/universal/) — shared `UNI-001` through `UNI-021` rules. Read these codex files directly.
