...
//! (`SPECIFY_VECTIS_MCP_URL`, the guest-kit `mcp_url` convention), never
...
use specify_vectis_core::{operations, registry};
...
struct VectisAdapter;

impl Guest for VectisAdapter {
