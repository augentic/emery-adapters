...
The lead applies every `UNI-*` rule from [`adapters/shared/prose/rules/universal/`](../../../../shared/prose/rules/universal/). Several universal checks overlap with categories already covered by the specialists; skip those:
