...
The lead applies every `UNI-*` rule from [`adapters/codex/rules/universal/`](../../../../codex/rules/universal/). Several universal checks overlap with categories already covered by the specialists; skip those:
