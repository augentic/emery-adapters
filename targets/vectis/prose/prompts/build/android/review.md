...
3. **Universal checks (lead).** Apply every `UNI-*` rule from [`codex/rules/universal/`](../../../../../../codex/rules/universal/) with Kotlin / Android heuristics. Full library: [`review/universal-checks.md`](../../../references/review/universal-checks.md).
