...
- Modified domains list existing baseline spec folders that change behaviourally; new requirement-IDs append, modified IDs keep their number, removed IDs carry a deletion note.
