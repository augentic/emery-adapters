...
Standards enforcement is **not** a workflow phase: findings may block a pipeline but never transition a slice or write lifecycle fields. Running `emery plan execute` is operator approval of a plan, not engineering-standards enforcement.
