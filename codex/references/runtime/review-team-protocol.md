...
4. **Pattern compliance**: Fix follows established patterns in the Omnia target build prompt's verify-repair section (see [Omnia build verify-repair loop](https://emery.augentic.io/reference/targets/omnia.html) § Verify-repair loop)
