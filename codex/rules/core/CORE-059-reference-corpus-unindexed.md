...
rule_hints:
  - kind: presence
    ...
    config:
      roots:
        - sources/*/prose/references/*
        - targets/*/prose/references/*
        - codex/references/*
      index: README.md
      min-files: 2
