...
pub const TOKENS_SCHEMA_SOURCE: &str = include_str!("../embedded/tokens.schema.json");

/// Canonical tool-owned `assets.schema.json` (the tool-owned schema and catalog decisions D1).
pub const ASSETS_SCHEMA_SOURCE: &str = include_str!("../embedded/assets.schema.json");
...
pub const COMPOSITION_SCHEMA_SOURCE: &str = include_str!("../embedded/composition.schema.json");
