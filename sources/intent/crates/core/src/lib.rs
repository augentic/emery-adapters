//! Wasm-free core of the intent source adapter (RFC-61 Step 3).
//!
//! Everything the intent guest does that is not platform glue lives
...
//! `specify-prose-registry`; this crate keeps only what is intent:
//!
...
//! shim (`specify-intent`, the adapter-root package) owns bindings
//! and export glue.
