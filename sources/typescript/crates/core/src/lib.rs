//! Wasm-free core of the typescript source adapter (RFC-61 Step 3).
//!
//! Everything the typescript guest does that is not platform glue lives
...
//! `specify-prose-registry`; this crate keeps only what is typescript:
//!
...
//! shim (`specify-typescript`, the adapter-root package) owns bindings
//! and export glue.
