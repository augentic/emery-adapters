//! Wasm-free core of the screenshots source adapter (RFC-61 Step 3).
//!
//! Everything the screenshots guest does that is not platform glue lives
...
//! `specify-prose-registry`; this crate keeps only what is screenshots:
//!
...
//! shim (`specify-screenshots`, the adapter-root package) owns bindings
//! and export glue.
