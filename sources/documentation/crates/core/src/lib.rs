//! Wasm-free core of the documentation source adapter (RFC-61 Step 3).
//!
//! Everything the documentation guest does that is not platform glue lives
...
//! `specify-prose-registry`; this crate keeps only what is documentation:
//!
...
//! shim (`specify-documentation`, the adapter-root package) owns bindings
//! and export glue.
